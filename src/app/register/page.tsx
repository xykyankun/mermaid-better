...
import { Mail, Lock, User, ArrowRight, Sparkles, Github, Check } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:flex-1 relative overflow-hidden bg-gradient-to-br from-purple-600 via-pink-500 to-orange-500">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-white p-12">
          <div className="max-w-md space-y-8">
            ...
            <p className="text-lg text-white/90">
              Get started with Mermaid Better and unlock powerful diagram creation tools.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-white/80">Monaco editor with live Mermaid preview</div>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0 mt-1">
                ...
                <div>
                  <div className="font-semibold">12 Templates</div>
                  <div className="text-sm text-white/80">Pre-built templates for quick start</div>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0 mt-1">
                ...
                <div>
                  <div className="font-semibold">Share & Collaborate</div>
                  <div className="text-sm text-white/80">Share diagrams with public links</div>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0 mt-1">
                ...
                <div>
                  ...
                  <div className="text-sm text-white/80">Export as PNG, SVG, or copy code</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600">
              Start creating beautiful diagrams in minutes
            </p>
          </div>
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-start">
              ...
              <label htmlFor="terms" className="ml-2 text-sm text-gray-600">
                ...
                and{' '}
                <Link href="/privacy" className="font-medium text-purple-600 hover:text-purple-700">
                  Privacy Policy
                </Link>
              </label>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                className="flex items-center justify-center gap-2 px-4 py-3 border border-gray-300 rounded-xl text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-all transform hover:scale-[1.02]"
              >
